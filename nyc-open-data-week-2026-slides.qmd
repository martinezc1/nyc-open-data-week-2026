...
```{r}
#| label: tbl-Contingency-Table-joyce
#| include: false
contingency_table <- xtabs(~Rating_Group+Near_Museum, data=merged_restaurant_data)
contingency_table
...
**Goal:** To provide an understanding in regards to those three factors to help policymakers evaluate whether current probation resources are sufficient to reduce recidivism among youth.
